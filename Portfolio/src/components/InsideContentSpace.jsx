...
function InsideContentSpace({ data }) {
  ...
  let renderingPage = () => {
    if (data.title === 'About Me') {
      return <About></About>
    } else if (data.title === 'Projects') {
      return <Projects></Projects>
    } else if (data.title === 'Skills') {
      return <Skills></Skills>
    } else if (data.title === 'Contact') {
    ...
    return (
      <div className="relative ">
        <div
          className="lg:h-[96vh] sm:z-10 lg:w-[25vw] sm:h-[40vw] sm:w-[94vw] fixed sm:ml-[3vw] lg:right-[1vw] lg:top-[1vw] rounded-xl sm:flex lg:flex lg:flex-col lg:items-center overflow-hidden "
          style={{
        ...
        >
          ...
          <div className="lg:h-[40vw] sm:h-[35vw] sm:w-full  lg:w-[22vw] group lg:mt-[2vw] sm:mt-[3vw] lg:border-b-[0.06vw]  lg:border-[#cfd9df] flex flex-col lg:items-end lg:justify-between ">
            ...
            <div className="lg:h-[26vw] lg:fixed lg:w-[10vw] lg:mt-[10vw]  lg:mb-[1vw]  lg:flex lg:flex-col lg:justify-between lg:items-center ">
        ...
        <div className="lg:w-[74vw] lg:h-[100vh] sm:w-[94vw] sm:h-[200vw]  sm:absolute sm:ml-[3vw] lg:relative lg:ml-0 lg:mt-0  sm:mt-[41vw]  lg:flex lg:justify-center  "
        >
          {renderingPage()}
          {/* <About></About>
          <Projects></Projects>
