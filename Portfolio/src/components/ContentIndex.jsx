                    ...
                    return (
                        ...
                        <Link key={data.id} to={`/${data.route}`} >
                            ...
                            >
                                ...
                                <div className={`lg:w-[12vw] lg:h-[12vw] opacity-[0.4] sm:h-[35vw] sm:w-[35vw] lg:group-hover:w-[11vw] lg:group-hover:h-[11vw] sm:group-hover:w-[32vw] sm:group-hover:h-[32vw] transition-all duration-300 absolute lg:-right-[2vw] lg:-top-[1.8vw] sm:-right-[3vw] sm:-top-[3vw] rounded-full `}
