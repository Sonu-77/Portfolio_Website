        ...
        <>
            {
                datas.map((data) => {
                    return (
                        ...
                        <div key={data.id} className={`relative flex lg:h-[100%] sm:h-[50vw] sm:w-[100%] lg:w-[100%] group lg:pl-[2vw] sm:pl-[4vw] justify-start lg:gap-[1vw] sm:gap-[3vw] items-center overflow-hidden`} 
